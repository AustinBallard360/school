...
// LUKE SCHULZ !!!!! 
// GCC and then Visual studio. I checked it on both. I had some weird experience where it worked on GCC but was super broken on visual studio. Should work everywhere now.
